...
cdef cnp.ndarray[cnp.float64_t, ndim=1] expanding(Expanding r, cnp.ndarray a):
    cdef int  i
    cdef int  N = len(a)
...
def expanding_mean(cnp.ndarray a):
    cdef Mean r = Mean()
    return expanding(r, a)

def expanding_slope(cnp.ndarray a):
    cdef Slope r = Slope()
    return expanding(r, a)

def expanding_rsquare(cnp.ndarray a):
    cdef Rsquare r = Rsquare()
    return expanding(r, a)

def expanding_resi(cnp.ndarray a):
    cdef Resi r = Resi()
    return expanding(r, a)
