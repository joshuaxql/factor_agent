...
_QLIB_DATA_DEFAULT = os.environ.get("QLIB_DATA", "~/.qlib/qlib_data/cn_data")
...
class QSettings(BaseSettings):
    ...
    provider_uri: str = _QLIB_DATA_DEFAULT
...
_default_config = {
    ...
    "logging_level": "INFO",
    # Keep loguru's default sink/format by default.
    # Pass logging_config to qlib.init(...) only when custom loguru sinks are needed.
    "logging_config": None,
    "pit_record_type": {
        "date": "I",  # uint32
        "period": "I",  # uint32
...
HIGH_FREQ_CONFIG = {
    "provider_uri": os.environ.get("QLIB_DATA_1MIN", _QLIB_DATA_DEFAULT + "_1min"),
    "dataset_cache": None,
